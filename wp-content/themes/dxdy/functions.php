...
class DxDySite extends TimberSite
{
    ...
    {
        // $twig->addFunction(new Timber\Twig_Function('get_random_number', 'dxdy_get_random_number'));

        // $twig->addFilter(new Timber\Twig_Filter('charlimit', 'dxdy_timber_charlimit'));
...
function dxdy_yoast_to_bottom() {
	return 'low';
}
add_filter('wpseo_metabox_prio', 'dxdy_yoast_to_bottom');

// custom shortcodes
require_once(get_template_directory() . '/includes/dxdy_shortcodes.php');

// option pages
if( function_exists('acf_add_options_page') ) {
  acf_add_options_page([
    'page_title'  => 'DxDy Global Settings',
